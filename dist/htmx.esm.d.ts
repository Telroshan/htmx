...
declare namespace htmx {
    ...
    const on: (arg1: string | EventTarget, arg2: string | EventListener, arg3?: any, arg4?: any) => EventListener;
    ...
    const defineExtension: (name: string, extension: Partial<HtmxExtension>) => void;
